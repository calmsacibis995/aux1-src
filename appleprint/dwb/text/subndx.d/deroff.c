#ifndef lint	/* .../appleprint/dwb/text/subndx.d/deroff.c */
#define _AC_NAME deroff_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:10:51}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of deroff.c on 87/11/11 22:10:51";
...
int mac = MM;
int disp = 0;
int sign = 0;  /* sign is 0 for flags beginning with - and 1 for + */
int parag = 0;
int inmacro = NO;
int intable = NO;
	...
	if(sp == 1)
		if(optind >= argc ||
		   (argv[optind][0] != '-'  && argv[optind][0] != '+')
		    || argv[optind][1] == '\0')
			return(EOF);
		if(argv[optind][0] == '-') sign = 0;
		if(argv[optind][0] == '+') sign = 1;
