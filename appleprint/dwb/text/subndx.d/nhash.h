#ifndef lint	/* .../appleprint/dwb/text/subndx.d/nhash.h */
#define _AC_NAME nhash_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:12:02}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *nhash_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of nhash.h on 87/11/11 22:12:02";
#endif		/* _AC_HISTORY */
#endif		/* lint */
