#ifndef lint	/* .../appleprint/dwb/text/subndx.d/ehash.h */
#define _AC_NAME ehash_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:11:22}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *ehash_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of ehash.h on 87/11/11 22:11:22";
#endif		/* _AC_HISTORY */
#endif		/* lint */
	...
	for (i = 0; i < aatsize; i++) {
		if (tbl[p1].aakey == 0) { /* new item */
			if (ex == 0) {
				...
				return(0);
		} else if (strcmp(tbl[p1].aakey, s) == 0) {
			return(tbl[p1].aadata->val);
		}
		p1 = (p1 + p2) % aatsize;
	}
