#ifndef lint	/* .../appleprint/dwb/text/neqn.d/text.c */
#define _AC_NAME text_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:55:56}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of text.c on 87/11/11 21:55:56";
#endif		/* _AC_HISTORY */
#endif		/* lint */
