#ifndef lint	/* .../appleprint/dwb/text/tbl.d/t6.c */
#define _AC_NAME t6_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:14:18}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of t6.c on 87/11/11 22:14:18";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
for(icol=0; icol <ncol; icol++)
   ...
   for(text=0; text<2; text++)
	...
	if (k=lspan(ilin, icol))
		...
		fprintf(tabout, ".if \\n(%d>0 .nr %d \\n(%d/%d\n", TMP, TMP, TMP, k);
		fprintf(tabout, ".if \\n(%d<0 .nr %d 0\n", TMP, TMP);
		for(ik=0; ik<=k; ik++) /* ik initialized to 0 instead of 1 MR us83-25801 */
			{
