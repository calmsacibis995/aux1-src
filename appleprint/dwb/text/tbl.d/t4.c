#ifndef lint	/* .../appleprint/dwb/text/tbl.d/t4.c */
#define _AC_NAME t4_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:14:11}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of t4.c on 87/11/11 22:14:11";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
while (c=get1char())
	...
	switch(c)
		...
		case '.': /* end of table specification */
			ncol = max(ncol, icol);
			if (ncol<icol+1 &&lefline[ncol][nclin]>0) {ncol++; rightl++;};
			if(sawchar)
				nclin++;
			if (nclin>=MAXHEAD)
