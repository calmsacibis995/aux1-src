#ifndef lint	/* .../appleprint/dwb/text/tbl.d/t8.c */
#define _AC_NAME t8_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:14:25}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of t8.c on 87/11/11 22:14:25";
#endif		/* _AC_HISTORY */
#endif		/* lint */
