#ifndef lint	/* .../appleprint/dwb/text/roff.d/n5.c */
#define _AC_NAME n5_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:09:18}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of n5.c on 87/11/11 22:09:18";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
e1:
	...
	envcopy((struct env *) &corebuf[ev * sizeof(env)/sizeof(tchar)], &env);
	envcopy(&env, (struct env *) &corebuf[nxev * sizeof(env)/sizeof(tchar)]);
	}
#else
...
envcopy(e1, e2)	/* copy env e2 to e1 */
	struct env *e1, *e2;
{
	*e1 = *e2;
}
