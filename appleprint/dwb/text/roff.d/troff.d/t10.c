#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/t10.c */
#define _AC_NAME t10_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:07:33}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of t10.c on 87/11/11 22:07:33";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
ptinit()
{
	...
	*/
	...
	if (nchtab >= NCHARS - 128) {
		errprint("too many special characters in file %s", termtab);
		done3(1);
	}
