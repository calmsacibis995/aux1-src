#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/impdraw.c */
#define _AC_NAME impdraw_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:04:54}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of impdraw.c on 87/11/11 22:04:54";
#endif		/* _AC_HISTORY */
#endif		/* lint */
