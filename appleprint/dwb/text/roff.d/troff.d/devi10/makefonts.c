#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/makefonts.c */
#define _AC_NAME makefonts_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:05:02}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of makefonts.c on 87/11/11 22:05:02";
...

{
	...
	do {
		...
		while ( isspace(fonts[i++] = getc(fp_change)) ) ;
