#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/rast.h */
#define _AC_NAME rast_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:06:08}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *rast_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of rast.h on 87/11/11 22:06:08";
#endif		/* _AC_HISTORY */
#endif		/* lint */
