#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/impcodes.h */
#define _AC_NAME impcodes_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:04:50}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *impcodes_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of impcodes.h on 87/11/11 22:04:50";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
/*
 *
 * A few special Impress definitions - primarily used with graphics.
 *
 */
