#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/dimpress.c */
#define _AC_NAME dimpress_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:04:01}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of dimpress.c on 87/11/11 22:04:01";
