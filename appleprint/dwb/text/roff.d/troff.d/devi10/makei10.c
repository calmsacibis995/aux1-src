#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devi10/makei10.c */
#define _AC_NAME makei10_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:05:22}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of makei10.c on 87/11/11 22:05:22";
...
#define	FONTDIR		50					/* max length of *fontdir string */
...
#define	MAXFONTS	50					/* can map this many fonts */
#define	NFONT		4					/* search at most this many fonts */
...
char	targdir[TARGDIR] = "rasti10";			/* target device's raster directory */
