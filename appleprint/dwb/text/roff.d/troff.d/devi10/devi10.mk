...
# @(#)Copyright Apple Computer 1987\tVersion 1.2 of devi10.mk on 87/11/11 22:03:59
...
i10_rasts:	$(MAKEDEV)
	cd rasti10; $(MAKE) -f rasti10.mk all ROOT=$(ROOT) CH=$(CH) \
		INS=$(INS) CFLAGS=$(CFLAGS) LDFLAGS=$(LDFLAGS)

unsup:	$(UNSUP)

makei10:	makei10.c ../dev.h
	$(CC) $(CFLAGS) $(LDFLAGS) -I../ -o makei10 makei10.c
makefonts:	makefonts.c ../dev.h
	$(CC) $(CFLAGS) $(FFLAG) $(LDFLAGS) -I../ -o makefonts makefonts.c
