#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devaps/makedev.c */
#define _AC_NAME makedev_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:01:43}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of makedev.c on 87/11/11 22:01:43";
 ...
 */
	...
	for ( i = 0; i < count/2; i++ )  {
		...
		if ( strcmp(s[i], "font") == 0 )  {	/* get char from another font */
			code[nw] |= FONT_BIT;		/* daps checks this bit */
...
add_font(name)
	...
	char	*name;			/* name of current font */
