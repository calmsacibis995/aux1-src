#ifndef lint	/* .../appleprint/dwb/text/roff.d/troff.d/devaps/daps.c */
#define _AC_NAME daps_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:00:34}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of daps.c on 87/11/11 22:00:34";
...

{
	...
	int		wrap_up();					/* signal handling routine */
	int		float_err();				/* handles floating point errors */
