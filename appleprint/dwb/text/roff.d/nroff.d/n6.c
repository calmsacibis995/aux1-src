#ifndef lint	/* .../appleprint/dwb/text/roff.d/nroff.d/n6.c */
#define _AC_NAME n6_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:58:38}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of n6.c on 87/11/11 21:58:38";
#endif		/* _AC_HISTORY */
#endif		/* lint */
