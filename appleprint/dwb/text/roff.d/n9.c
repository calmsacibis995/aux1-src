#ifndef lint	/* .../appleprint/dwb/text/roff.d/n9.c */
#define _AC_NAME n9_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:09:41}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of n9.c on 87/11/11 22:09:41";
#endif		/* _AC_HISTORY */
#endif		/* lint */
