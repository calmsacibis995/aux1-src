#ifndef lint	/* .../appleprint/dwb/text/roff.d/tdef.h */
#define _AC_NAME tdef_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 22:10:05}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *tdef_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of tdef.h on 87/11/11 22:10:05";
#endif		/* _AC_HISTORY */
#endif		/* lint */
