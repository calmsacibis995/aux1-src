#ifndef lint	/* .../appleprint/dwb/text/roff.d/ni.c */
#define _AC_NAME ni_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.3 87/11/11 22:09:45}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.3 of ni.c on 87/11/11 22:09:45";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
char	termtab[NS] = "/usr/lib/nterm/tab.";	/* term type added in ptinit() */
