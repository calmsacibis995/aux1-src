#ifndef lint	/* .../appleprint/dwb/text/eqn.d/main.c */
#define _AC_NAME main_c
#define _AC_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:51:34}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of main.c on 87/11/11 21:51:34";
	...
	char *s;
{
	if (strcmp(s, "202") == 0)
		...
		{ res = 576; minsize = 2; ttype = DEVPSC; }
	else if (strcmp(s, "iw") == 0)
		{ res = 144; minsize = 6; ttype = DEVIW; }
	else
