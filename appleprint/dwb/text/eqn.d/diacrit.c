#ifndef lint	/* .../appleprint/dwb/text/eqn.d/diacrit.c */
#define _AC_NAME diacrit_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:50:52}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of diacrit.c on 87/11/11 21:50:52";
#endif		/* _AC_HISTORY */
#endif		/* lint */
