%{
#ifndef lint	/* .../appleprint/dwb/text/grap.d/grap.y */
#define _AC_NAME grap_y
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:53:10}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of grap.y on 87/11/11 21:53:10";
#endif		/* _AC_HISTORY */
#endif		/* lint */
%}
...
%token	<i>	LOG EXP SIN COS ATAN2 SQRT RAND MAX MIN INT PRINT
...
%type	<ap>	linedesc optdesc stringlist string stringattr sattrlist
...
top:
	...
	| /* empty */		{ codegen = 0; }
	| error			{ codegen = 0; yyerror("syntax error"); }
	;
...
tickattr:
	...
	| AT optname ticklist	{ setlist(); ticklist($2); }
	| iterator		{ setlist(); ticklist($1); }
	| side OFF		{ tickoff($1); }
...
stringlist:
	...
	;
string:
	  STRING sattrlist	{ $$ = makesattr($1, $2); }
	;
sattrlist:
	  stringattr
