#ifndef lint	/* .../appleprint/dwb/text/grap.d/grap.h */
#define _AC_NAME grap_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:53:05}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *grap_h_sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of grap.h on 87/11/11 21:53:05";
#endif		/* _AC_HISTORY */
#endif		/* lint */
