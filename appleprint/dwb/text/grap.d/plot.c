#ifndef lint	/* .../appleprint/dwb/text/grap.d/plot.c */
#define _AC_NAME plot_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:53:33}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of plot.c on 87/11/11 21:53:33";
#endif		/* _AC_HISTORY */
#endif		/* lint */
	...
	Point pt;
{
	if (r > 0.0)
		...
		fprintf(tfd, "\"\\fH\\s-3o\\s0\\fP\" at %s\n", xyname(pt));
	range(pt);
}
