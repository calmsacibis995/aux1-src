#ifndef lint	/* .../appleprint/dwb/text/grap.d/misc.c */
#define _AC_NAME misc_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:53:30}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987	Version 1.2 of misc.c on 87/11/11 21:53:30";
#endif		/* _AC_HISTORY */
#endif		/* lint */
