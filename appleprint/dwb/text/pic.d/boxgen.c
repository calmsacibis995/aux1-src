#ifndef lint	/* .../appleprint/dwb/text/pic.d/boxgen.c */
#define _AC_NAME boxgen_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:56:32}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of boxgen.c on 87/11/11 21:56:32";
#endif		/* _AC_HISTORY */
#endif		/* lint */
