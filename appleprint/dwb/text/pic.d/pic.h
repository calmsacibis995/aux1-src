#ifndef lint	/* .../appleprint/dwb/text/pic.d/pic.h */
#define _AC_NAME pic_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.2 87/11/11 21:57:21}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *pic_h_pic_h_sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of pic.h on 87/11/11 21:57:21";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
extern	char	*ifstat(), *delimstr();

extern	float	deltx, delty;
extern	int	lineno;
extern	int	synerr;
extern	int	crop;
extern	int	devtype, res;
...
extern	obj	*makenode(), *makepos(), *fixpos(), *makebetween();
