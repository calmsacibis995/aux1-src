#ifndef lint	/* .../enscript.c */
#define _AC_NAME enscript_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:46:02}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_enscript_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of enscript.c on 87/11/11 21:46:02";
