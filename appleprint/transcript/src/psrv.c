#ifndef lint	/* .../psrv.c */
#define _AC_NAME psrv_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:33}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_psrv_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of psrv.c on 87/11/11 21:48:33";
...
#ifndef lint
#define _AC_MODS
static char *RCSID="$Header: psrv.c,v 2.1 85/11/24 11:51:09 shore Rel $";
#endif
/* psrv.c
 *
