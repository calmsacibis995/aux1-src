#ifndef lint	/* .../ps630.c */
#define _AC_NAME ps630_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:46:44}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_ps630_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of ps630.c on 87/11/11 21:46:44";
...
#ifndef lint
#define _AC_MODS
static char *RCSID="$Header: ps630.c,v 2.1 85/11/24 11:49:36 shore Rel $";
#endif
/* ps630.c
 *
