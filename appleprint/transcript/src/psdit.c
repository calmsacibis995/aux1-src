#ifndef lint	/* .../psdit.c */
#define _AC_NAME psdit_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:04}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_psdit_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of psdit.c on 87/11/11 21:48:04";
