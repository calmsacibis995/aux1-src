#ifndef lint	/* .../psrev.c */
#define _AC_NAME psrev_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:27}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_psrev_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of psrev.c on 87/11/11 21:48:27";
