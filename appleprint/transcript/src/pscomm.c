#ifndef lint	/* .../pscomm.c */
#define _AC_NAME pscomm_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:47:34}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_pscomm_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of pscomm.c on 87/11/11 21:47:34";
...
#ifndef lint
#define _AC_MODS
static char *RCSID="$Header: pscomm.sysv,v 2.1 85/11/24 11:50:32 shore Rel $";
#endif
/* pscomm.c
 *
