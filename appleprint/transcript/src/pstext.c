#ifndef lint	/* .../pstext.c */
#define _AC_NAME pstext_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:40}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_pstext_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of pstext.c on 87/11/11 21:48:40";
