#ifndef lint	/* .../pscat.c */
#define _AC_NAME pscat_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:47:06}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_pscat_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of pscat.c on 87/11/11 21:47:06";
...
#ifndef lint
#define _AC_MODS
static char *RCSID="$Header: pscat.c,v 2.1 85/11/24 11:49:56 shore Rel $";
#endif
/* pscat.c
 *
 ...
 *
 * Edit History:
 * Andrew Shore: Thu Nov 21 09:49:50 1985
 * End Edit History.
 *
 * RCSLOG:
 * $Log:	pscat.c,v $
...
private VOID xCATfile()
{
    ...
    if (!havemap) {
	LoadMap(mstrcat(tempfile, TroffFontDir, "Times.ct", sizeof tempfile));
    }
...
int pointsize;
{
    ...
    ShowChar(c);
    wantPSx = curPSx += (long) (((long) cd->pswidth * PSsize + 500L) / 1000L);
}
