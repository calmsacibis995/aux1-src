#ifndef lint	/* .../types.h */
#define _AC_NAME types_h
#define _AC_NO_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:49}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_types_h[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of types.h on 87/11/11 21:48:49";
#endif		/* _AC_HISTORY */
#endif		/* lint */
