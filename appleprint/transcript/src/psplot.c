#ifndef lint	/* .../psplot.c */
#define _AC_NAME psplot_c
#define _AC_MAIN "@(#) Copyright (c) 1985 Adobe Systems Incorporated, All Rights Reserved.  {Apple version 1.2 87/11/11 21:48:20}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char ___src_psplot_c[] = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of psplot.c on 87/11/11 21:48:20";
...
#ifndef lint
#define _AC_MODS
static char *RCSID="$Header: psplot.c,v 2.1 85/11/24 11:50:57 shore Rel $";
#endif
/* psplot.c
 *
