...
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.3 87/11/11 21:25:23}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.3 of msg.c on 87/11/11 21:25:23";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
msginit()
{
	...
	if (availrmem < tune.t_minarmem  || availsmem < tune.t_minasmem) {
		...
		msg = (paddr_t) sptalloc(bs, PG_V | PG_RW, -1);
	}
#else
