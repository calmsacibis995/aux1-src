...
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 Motorola Inc., 1985-87 UniSoft Corporation, All Rights Reserved.  {Apple version 1.4 87/11/11 21:27:32}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.4 of sysm68k.c on 87/11/11 21:27:32";
#endif		/* _AC_HISTORY */
#endif		/* lint */
