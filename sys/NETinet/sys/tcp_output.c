...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.3 87/11/11 21:20:28}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.3 of tcp_output.c on 87/11/11 21:20:28";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
#else
	error = ip_output(m, tp->t_ipopt, &tp->t_inpcb->inp_route, 
			  so->so_options & SO_DONTROUTE);
#endif
	if (error)
		return (error);
