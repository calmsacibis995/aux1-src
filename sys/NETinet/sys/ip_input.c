...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.4 87/11/11 21:19:41}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.4 of ip_input.c on 87/11/11 21:19:41";
#endif		/* _AC_HISTORY */
#endif		/* lint */
	...
	struct ifnet *ifp;
{
	...
	return (0);
bad:
	icmp_error(ip, type, code, ifp, (struct in_addr *)0);
	return (1);
}
