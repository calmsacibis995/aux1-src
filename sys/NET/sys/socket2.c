...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.3 87/11/11 21:17:36}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.3 of socket2.c on 87/11/11 21:17:36";
#endif		/* _AC_HISTORY */
#endif		/* lint */
	...
	*mtod(m, struct sockaddr *) = *asa;
	if (rightsflag) {
		if (rights0 == 0 || rights0->m_len == 0) {
			rights = m_get(M_DONTWAIT, MT_RIGHTS);
			if (rights)
				rights->m_len = 0;
		} else
