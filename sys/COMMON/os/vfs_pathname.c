...
#define _AC_NO_MAIN "@(#) Copyright (c) 1983-87 Sun Microsystems Inc., All Rights Reserved.  {Apple version 1.3 87/11/13 12:13:19}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.1 of vfs_pathname.c on 87/05/04 01:23:45";
#endif		/* _AC_HISTORY */
#endif		/* lint */
