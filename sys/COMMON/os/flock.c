...
#define _AC_NO_MAIN "@(#) Copyright (c) 1984-85 AT&T-IS, All Rights Reserved.  {Apple version 1.4 87/11/11 21:11:19}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.4 of flock.c on 87/11/11 21:11:19";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
struct file *fp;
{
	...
	if ((fp->f_type == DTYPE_VNODE) &&
		...
		/* release all locking(2) based locks by this process on this vnode */
		unlock(VTOI((struct vnode*) fp->f_data));
