#ifndef lint	/* .../sys/psn/io/fdb.c */
#define _AC_NAME fdb_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., All Rights Reserved.  {Apple version 1.3 87/11/19 18:01:10}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.3 of fdb.c on 87/11/19 18:01:10";
#endif		/* _AC_HISTORY */
#endif		/* lint */
