...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., All Rights Reserved.  {Apple version 1.12 87/12/01 18:26:31}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.12 of video.c on 87/12/01 18:26:31";
#endif		/* _AC_HISTORY */
#endif		/* lint */
