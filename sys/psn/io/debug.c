...
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., All Rights Reserved.  {Apple version 1.6 87/11/19 18:00:45}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.6 of debug.c on 87/11/19 18:00:45";
#endif		/* _AC_HISTORY */
#endif		/* lint */
...
#else NEW_PMMU
			i = pptop(p->p_uptbl[0].pgm[0].pg_pfn);
...
#if (defined(COMMAND) | defined(PSARGS)) && ! defined(NEW_PMMU)
