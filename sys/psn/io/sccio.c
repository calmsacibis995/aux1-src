#ifndef lint	/* .../sys/psn/io/sccio.c */
#define _AC_NAME sccio_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1987 Apple Computer, Inc., All Rights Reserved.  {Apple version 1.6 87/11/19 18:02:41}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.6 of sccio.c on 87/11/19 18:02:41";
#endif		/* _AC_HISTORY */
#endif		/* lint */
