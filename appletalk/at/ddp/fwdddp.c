#ifndef lint	/* .../appletalk/at/ddp/fwdddp.c */
#define _AC_NAME fwdddp_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 UniSoft Corporation, All Rights Reserved.  {Apple version 1.2 87/11/11 20:57:14}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of fwdddp.c on 87/11/11 20:57:14";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *****************************************************************************
 */
#define	MODULE_NAME	"icpddp_"
#define	MODULE_INFO	icpddp_info
