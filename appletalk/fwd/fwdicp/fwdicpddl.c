#ifndef lint	/* .../appletalk/fwd/fwdicp/fwdicpddl.c */
#define _AC_NAME fwdicpddl_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 UniSoft Corporation, All Rights Reserved.  {Apple version 1.2 87/11/11 21:09:15}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of fwdicpddl.c on 87/11/11 21:09:15";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *****************************************************************************
 */
#define	MODULE_NAME	"ddp_loop"
#define	MODULE_NUM	(FORWARDERMIN+6)
...
struct  streamtab       fwdddl_info =	{&fwdrdata, &fwdwdata, NULL, NULL};
...
dev_t dev, *devp;
{
	return(fwd_open(q, dev, flag, sflag, err, devp, &icp_specifics[0]));
}
