#ifndef lint	/* .../appletalk/fwd/fwdicp/fwdicploop.c */
#define _AC_NAME fwdicploop_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 UniSoft Corporation, All Rights Reserved.  {Apple version 1.2 87/11/11 21:09:36}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of fwdicploop.c on 87/11/11 21:09:36";
#endif		/* _AC_HISTORY */
#endif		/* lint */
 ...
 *****************************************************************************
 */
#define	MODULE_NAME	"fwd_loop"
#define	MODULE_NUM	(FORWARDERMIN+1)
...
struct  streamtab       fwdicploop_info = {&fwdrdata, &fwdwdata, NULL, NULL};
