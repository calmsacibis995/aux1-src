#ifndef lint	/* .../appletalk/fwd/fwdicp/fwdicptt.c */
#define _AC_NAME fwdicptt_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 UniSoft Corporation, All Rights Reserved.  {Apple version 1.2 87/11/11 21:09:48}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of fwdicptt.c on 87/11/11 21:09:48";
#endif		/* _AC_HISTORY */
#endif		/* lint */

#define _AC_MODS
/*	@(#)fwdicptt.c	UniPlus VVV.2.1.1	*/
 ...
 *****************************************************************************
 */
#define	MODULE_NAME	"fwd_asyn"
#define	MODULE_NUM	(FORWARDERMIN+5)
...
struct  streamtab       fwdtt_info =	{&fwdrdata, &fwdwdata, NULL, NULL};
...
dev_t dev, *devp;
{
	return(fwd_open(q, dev, flag, sflag, err, devp, &icp_specifics[(minor(dev)>>2)&0x3f]));
}
