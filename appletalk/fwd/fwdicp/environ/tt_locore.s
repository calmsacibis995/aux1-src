#	@(#)Copyright Apple Computer 1987	Version 1.2 of tt_locore.s on 87/11/11 21:07:58 VV.2.1.1
...
#ident	"@(#)tt_locore.s 1.1 87/04/02"
	...
	long	scc2%		# 28	Level 4 Interrupt Autovector
	long	scc1%		# 29	Level 5 Interrupt Autovector
 ...
 # and call the system interrupt dispatcher
	...
	global	fault, call%, scintr, viairupt
...
clrbss%:mov.l	&0,(%a0)+		# Clear bss
 ...
 # spl commands
	global	splhi, splx, spltty, splclock, spl7
