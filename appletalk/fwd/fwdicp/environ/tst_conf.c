#ifndef lint	/* .../appletalk/fwd/fwdicp/environ/tst_conf.c */
#define _AC_NAME tst_conf_c
#define _AC_NO_MAIN "@(#) Copyright (c) 1985-87 UniSoft Corporation (Warning - possible offset problems!!!), All Rights Reserved.  {Apple version 1.2 87/11/11 21:07:35}"
#include <apple_notice.h>

#ifdef _AC_HISTORY
  static char *sccsid = "@(#)Copyright Apple Computer 1987\tVersion 1.2 of tst_conf.c on 87/11/11 21:07:35";
#endif		/* _AC_HISTORY */
#endif		/* lint */
